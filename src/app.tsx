        ...
        <div className="space-y-4">
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              ...
              <div className="w-px h-6 bg-zinc-800" />
              <button className="flex items-center gap-2 rounded-lg bg-lime-300 text-lime-950 px-5 py-2 font-semibold hover:bg-lime-400 transition-colors">
                Confirmar viagem
                <ArrowRight className="size-5" />
              </button>
            </div>
          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-sm text-zinc-400">
                Os convidados irão receber e-maisl para confirmar a participação
                da viagem.
              </p>
            </div>
            ...
            >
              ...
              <button
                type="submit"
                className="flex items-center gap-2 rounded-lg bg-lime-300 text-lime-950 px-5 py-2 font-semibold hover:bg-lime-400 transition-colors"
              >
                Convidar
